...
analysis: 
  <p style="text-indent: 2em;">(1) QAQC: data QAQC output for data review and error checks
  (2) tests_models: statistical tests and models (not descriptive stats of raw data visualization)

data:
  <p style="text-indent: 2em;">(1) raw_data: raw datasheets
...
<p style="text-indent: 2em;">(1) at different focal scales (plot, cluster, psu, lsu) 
